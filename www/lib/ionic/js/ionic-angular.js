 ...
 * @usage
 * ```js
 * var snakeApp = angular.module('reallyCoolApp', ['ionic']);
 *
 * snakeApp.config(function($ionicConfigProvider) {
 ...
 * @usage
 * ```js
 * var app = angular.module('snakeApp', ['ionic'])
 ...
 *
 * ```
 * angular.module('snakeApp', ['ngRoute'])`
 * ```
 *
 * becomes
 *
 * ```
 * angular.module('snakeApp', ['ngRoute', 'ngIOS9UIWebViewPatch'])
 * ```
 *
 *
 * More info:
